  ...
  return (
    <>
      ...
      <footer className="flex w-full bg-[#18181b] text-gray-100 py-5">
        <div className="flex flex-col sm:flex-row space-y-5 sm:space-y-0 justify-between sm:w-full xl:w-3/5 max-w-4xl mx-auto py-1 px-10">
          <div className="flex flex-col sm:flex-row sm:inline-flex sm:space-x-6">
            <span>&copy; {new Date().getFullYear()} Indiedevcasts</span>
            <Link
              href="/privacy-policy"
              className="text-gray-100 border-b-0 hover:border-b"
            >
              Privacy Policy
            </Link>
            <Link
...
function AboutIndiedevcasts() {
  return (
    <section className="blog-container my-28">
